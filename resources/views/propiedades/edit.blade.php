        ...
        <form method="POST" action="{{ route('propiedades.update', $propiedad) }}">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="alias" id="alias" value="{{ old('alias', $propiedad->alias) }}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                    @error('alias') <p class="text-red-600 text-sm">{{ $message }}</p> @enderror
                </div>

                <!-- Repite para las demás columnas igual que en create -->

                <div>
                    <label for="domicilio" class="block font-medium text-sm text-gray-700">Domicilio</label>
                    <input type="text" name="domicilio" id="domicilio" value="{{ old('domicilio', $propiedad->domicilio) }}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                ...
                <div>
                    ...
                    <input type="text" name="siapa" id="siapa" value="{{ old('siapa', $propiedad->siapa) }}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                ...
                <div>
                    ...
                    <input type="text" name="cfe" id="cfe" value="{{ old('cfe', $propiedad->cfe) }}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                ...
                <div>
                    ...
                    <input type="text" name="predial" id="predial" value="{{ old('predial', $propiedad->predial) }}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                ...
                <div>
                    ...
                    <input type="text" name="mantenimiento_banco" id="mantenimiento_banco" value="{{ old('mantenimiento_banco', $propiedad->mantenimiento_banco) }}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                ...
                <div>
                    ...
                    <input type="text" name="mantenimiento_cuenta" id="mantenimiento_cuenta" value="{{ old('mantenimiento_cuenta', $propiedad->mantenimiento_cuenta) }}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="mantenimiento_monto" id="mantenimiento_monto" value="{{ old('mantenimiento_monto', $propiedad->mantenimiento_monto) }}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                ...
                <div>
                    ...
                    <input type="text" name="latitud" id="latitud" value="{{ old('latitud', $propiedad->latitud) }}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                ...
                <div>
                    ...
                    <input type="text" name="longitud" id="longitud" value="{{ old('longitud', $propiedad->longitud) }}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
